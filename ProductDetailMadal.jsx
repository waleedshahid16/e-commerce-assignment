...
const ProductDetailModal = (props) => {
  ...
  const selectedProduct = ProductsData.find((product) => product.id === currentProductId);
                ...
                <Grid container spacing={4}>
                  <Grid size={6}>
                    <Swiper
                      ...
                      className="mySwiper"
                    >
                      <SwiperSlide><img src={selectedProduct?.img} alt="" /></SwiperSlide>
                  ...
                  <Grid size={6}>
                    <Box className="flex justify-between">
                      <Box>
                        ...
                        <Typography variant="body2">{selectedProduct?.weight}</Typography>
                      </Box>
                      <Box className="flex flex-col items-end">
                        ...
                        <Button variant="contained" sx={{ bgcolor: "#019376" }}>
                          <StarBorderIcon />
                        </Button>
                      </Box>
                    </Box>
